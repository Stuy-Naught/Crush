from crush_connector.models import Person, Crush, PersonBeenNotified
...
class Command(NoArgsCommand):
  def handle_noargs(self, *args, **kwargs):
    ...
    crushes_1 = Crush.objects.filter(crusher=tester_1, crushee=tester_2)
    crushes_2 = Crush.objects.filter(crusher=tester_2, crushee=tester_1)
